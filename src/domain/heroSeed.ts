...
export function createHeroState(): HeroScenarioState {
  return {
    ...
    edges: createEdges(),
    fleet: [
      { id: "AGV-01", status: "charging", nodeId: "CHARGE-01", batteryPercent: 98, capacityKg: 1200, speedMps: 0.9, currentTaskId: null },
      { id: "AGV-02", status: "moving", nodeId: "N11", batteryPercent: 64, capacityKg: 1200, speedMps: 0.85, currentTaskId: "TASK-207" },
      { id: "AGV-03", status: "idle", nodeId: "N01", batteryPercent: 86, capacityKg: 1200, speedMps: 0.87, currentTaskId: null },
      { id: "AGV-04", status: "idle", nodeId: "N08", batteryPercent: 14, capacityKg: 1200, speedMps: 0.8, currentTaskId: null },
    ],
    ...
    metrics: { toolCalls: 0, completedMissions: 0, successfulReplans: 0, operatorApprovals: 0, unsafeRejections: 0, transportAttempts: 0 },
    blockageInjected: false,
    telemetry: { scenarioClockMs: 0, distanceTravelledMeters: 0, replans: 0, trace: [] },
  };
}
