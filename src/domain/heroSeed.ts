...
export function createHeroState(): HeroScenarioState {
  return {
    ...
    edges: createEdges(),
    fleet: [
      { id: "AGV-01", status: "charging", nodeId: "CHARGE-01", batteryPercent: 98, currentTaskId: null },
      { id: "AGV-02", status: "moving", nodeId: "N11", batteryPercent: 64, currentTaskId: "TASK-207" },
      { id: "AGV-03", status: "idle", nodeId: "N01", batteryPercent: 86, currentTaskId: null },
      { id: "AGV-04", status: "maintenance", nodeId: "N08", batteryPercent: 14, currentTaskId: null },
    ],
    pallet: { id: "P-104", status: "waiting", nodeId: "INBOUND-01", destinationNodeId: "RACK-A12" },
    mission: { id: "MISSION-HERO-001", status: "unassigned", assignedAgvId: null },
